...
exports.getUserProfile = exports.updateUserProfile = exports.findUser = exports.createUser = void 0;
...
const updateUserProfile = (userId, updateData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield User.findByIdAndUpdate(userId, updateData, { new: true });
});
